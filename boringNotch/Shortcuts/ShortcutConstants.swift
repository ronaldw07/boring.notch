...
extension KeyboardShortcuts.Name {
    ...
    // three with the system while a notch is open and unregisters them the
    // moment the last one closes — otherwise they would swallow every 1, 2
    // and 3 typed anywhere on the machine.
